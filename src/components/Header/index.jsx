  ...
  return (
    <div className='font-primary py-12 px-44 flex flex-row justify-between'>
      <div className='flex flex-row'>
        <img src={Logo} alt='logo' className='cursor-pointer w-28 h-10' />
      ...
      <div className='ml-24 font-bold flex flex-row'>
        ...
        <button className='btn rounded-full text-primary font-bold px-5 py-2 cursor-pointer hover:bg-primary hover:text-[#FFFFFF]'>
          Get Started
        </button>
      </div>
    </div>
